...
> = {
  en: {
    tag: 'Compare',
    h2: 'Nexora vs. paying for five tools separately.',
    sub: 'One subscription. One workspace. No more tool sprawl.',
    colNexora: 'Nexora',
    colTypical: 'Typical stack',
    colAgency: 'Agency retainers',
    rows: [
      { label: 'One subscription, predictable cost', nexora: true, typical: false, agency: false },
      ...
      { label: 'Automation and sequences without extra tools', nexora: true, typical: false, agency: 'partial' },
      { label: 'Self-serve setup in under 10 minutes', nexora: true, typical: 'partial', agency: false },
    ],
    footnote: 'Typical stack = separate CRM, AI tools, automation and reporting billed separately.',
  },
  es: {
    tag: 'Comparar',
    h2: 'Nexora frente a pagar por cinco herramientas por separado.',
    sub: 'Una suscripción. Un workspace. Sin herramientas dispersas.',
    colNexora: 'Nexora',
    colTypical: 'Stack típico',
    colAgency: 'Retainers de agencia',
    rows: [
      { label: 'Una suscripción, costo predecible', nexora: true, typical: false, agency: false },
      ...
      { label: 'Automatización sin herramientas extra', nexora: true, typical: false, agency: 'partial' },
      { label: 'Configuración propia en menos de 10 minutos', nexora: true, typical: 'partial', agency: false },
    ],
